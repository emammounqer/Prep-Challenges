...
function fullName(arr) {
    // write your code here
    return arr.map(stud => `${stud.firstName} ${stud.lastName}`)
}
// -------------------------------------------------------------------------------------------------------
...
function gradesAvg(arr) {
    ...
    return arr.map(stud => {
        let total = 0;
        stud.gradsList.map(grade => total += grade)
        stud.avg = total / stud.gradsList.length
        return stud
    })
}
// -------------------------------------------------------------------------------------------------------
...
function studentsResult(arr) {
    // write your code here
    return arr.map(stud => {
        stud.result = stud.avg < 50 ? 'Failed' : 'Passed'
        return stud
    })
}
// -------------------------------------------------------------------------------------------------------
